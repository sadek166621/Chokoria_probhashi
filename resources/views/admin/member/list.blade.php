                ...
                @if (count($members) > 0)
                  @foreach ($members as $key => $member)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.member.edit', $member->id) }}" class="btn btn-info"><i class="fas fa-edit"></i> Edit</a>
                        <a href="{{ route('admin.member.delete', $member->id) }}" onclick="if(!confirm('Are You Sure?')){return false}" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                        <a href="{{ route('admin.member.certificate-generate', $member->id) }}" onclick="if(!confirm('Are You Want To Genarate A Certificate?')){return false}" class="btn btn-default"><i class="fas fa-certificate"></i> C-G</a>
                      </td>
                    </tr>
                  @endforeach
                @else
