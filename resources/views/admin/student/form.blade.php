          ...
          <form action="@isset($student){{ route('admin.student.update', $student->id) }}@else{{ route('admin.student.store') }}@endisset"
            ...
            <input type="text" name="father_name" class="form-control" id="exampleInputEmail1" placeholder="Enter father's Name" @isset($student) value="{{ $student->father_name }}" @endisset required>
              ...
              <div class="col-sm-12">
                <div class="col-sm-4" style="float: left">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Roll Number</label><span style="color:red"> (Must be unique*)</span>
            <input type="number" name="roll_num" class="form-control" id="exampleInputEmail1" placeholder="Enter Roll Number" @isset($student) value="{{ $student->roll_num }}" @endisset required>
              ...
              <div class="col-sm-12">
                <div class="col-sm-6" style="float: left">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Gpa (obtunded In Ssc)</label>
                    <input type="text" name="gpa" class="form-control" id="exampleInputEmail1" placeholder="Enter Gpa (obtunded In Ssc)" @isset($student) value="{{ $student->gpa }}" @endisset required>
                  </div>
                </div>
                <div class="col-sm-6" style="float: left">
                  <div class="form-group">
                    <label for="exampleInputEmail1">From Which School Have Given Ssc</label>
                    <input type="text" name="fwshgs" class="form-control" id="exampleInputEmail1" placeholder="Enter From Which School Have Given Ssc" @isset($student) value="{{ $student->fwshgs }}" @endisset required>
                  </div>
                </div>
              </div>
              <div class="col-sm-12">
