...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Higher Secondary Exam Routine </h1>
      </div>
      <div class="col-sm-6">
                  ...
                  @foreach ($examroutines as $key => $examroutine)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('admin.examroutine.delete', $examroutine->id) }}" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                      </td>
                    </tr>
                  @endforeach
                @else
