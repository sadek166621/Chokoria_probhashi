...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['executive'] = Executive::count();
        $data['staff'] = Staff::count();
        $data['inactive'] = Member::where('status',0)->count();
        $data['members'] = Member::where('location_id',2)->latest()->take(2)->get();
        $data['staffs'] = Executive::latest()->take(2)->get();
